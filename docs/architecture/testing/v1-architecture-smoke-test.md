...
Подтвердить, что минимальный Operation flow способен пройти весь жизненный цикл без нарушения
архитектурных границ

## Принцип тестовых реализаций

Recording-компоненты подтверждают архитектурные контракты системы
Они не обязаны повторять внутреннюю реализацию Production-компонентов
